...
const Footer: React.FC<FooterProps> = ({ config, className = '' }) => {
  ...
  const formattedPhone = '+1 (470) 223-6127';
  const phoneLink = 'tel:+14702236127';
            ...
            <div className="lg:col-span-1">
              ...
              <div className="space-y-3 text-gray-200">
                ...
                <div className="flex items-start">
                  <svg
                    className="w-4 h-4 mr-3 mt-1 text-blue-400"
                    fill="currentColor"
                    viewBox="0 0 20 20"
                  >
                    <path
              ...
              <div className="mt-8">
                ...
                <div className="flex">
                  ...
                  <button
                    ...
                    className="px-4 py-2 bg-blue-600 hover:bg-blue-700 rounded-r-sm transition-colors"
                  >
