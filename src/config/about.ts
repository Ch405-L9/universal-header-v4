...
export const badgerTechAbout = {
  ...
  description: [
    'A.D. Grant brings 16.5 years of enterprise IT experience to small business success. As Founder of BADGRTechnologies LLC, I specialize in translating complex technical solutions into growth-driving digital assets for ambitious entrepreneurs.',
    "My background spans enterprise security implementations, scalable smart development frameworks, and comprehensive certifications in Python, Kotlin, UX/UI design, and advanced cybersecurity protocols. But here's what matters most: I understand that technology should solve problems, not create them.",
  ...
  team: {
    ...
    description:
      "We're not just developers — we're strategic partners invested in your success. Every project receives personal attention from initial planning through launch and ongoing optimization.",
  },
  badge: {
