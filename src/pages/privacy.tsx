...
const PrivacyPolicy: React.FC = () => {
  return (
    <>
      <Head>
        <title>Privacy Policy | BADGRTechnologies</title>
        <meta name="description" content="Privacy Policy for BADGR Technologies LLC. Learn how we collect, use, and protect your information." />
        <meta name="robots" content="index, follow" />
        <link rel="canonical" href="https://www.badgrtech.com/privacy" />
      </Head>
